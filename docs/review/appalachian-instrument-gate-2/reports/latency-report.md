...
| --- | ---: | ---: | ---: |
| Input to simulation receipt | 0.1 ms | 0.2 ms | 0.5 ms |
| Input to audio scheduling call | 164.1 ms | 173.1 ms | 175.8 ms |
| Input to first changed hero pixel | 1.3 ms | 18.8 ms | 19.6 ms |
| Input to first action frame | 0.5 ms | 0.8 ms | 1.3 ms |
...
AudioContext output latency: 0.536 s p50.
