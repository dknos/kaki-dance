...
| Input to audio scheduling call | 164.2 ms | 168.3 ms | 173.8 ms |
| Input to first changed hero pixel | 1.2 ms | 18.8 ms | 19.3 ms |
...
AudioContext output latency: 0.144 s p50.
